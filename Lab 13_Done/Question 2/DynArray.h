...
/* ##Part Two:  
This exercise demonstrates the concept of an iterator. 
Extend your DynArray class of the previous exercise such that the iterators.cpp file works correctly.
*/
...
public:
   ...
   void add(T x){ //taking an input of int x ... and adding it to the new array to be created...
       ...
       //################## I added a new function to find the size:
     ...
     int size(){
           int arraySize = sizeArray; //the getting the array size from our known size:

           return arraySize; //outputting the size
       } //end of size
