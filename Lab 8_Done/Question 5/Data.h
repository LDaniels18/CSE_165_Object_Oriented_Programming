...
class Data{ //class data
 ...
 vector<Sortable*> list; //allowing us to use a vector called list of int variables 
  public:
  ...
  void add(Sortable* number){ // putting something into my vector
  ...
  void sort(){ //double check this sorting method -- Worked with Ivan Padilla on this
